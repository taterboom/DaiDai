  ...
  return (
    <svg width="41" height="37" viewBox="0 0 41 37" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        fill="white"
      />
      <path d="M21.6482 18.6736H24.128V21.1534H21.6482V18.6736Z" fill="white" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export function RadixHeading(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path fill="currentColor" d="M18 20h-3v-6H9v6H6V5.009h3V11h6V5.009h3V20z"></path>
    </svg>
  )
}

export function RadixBold(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="1em"
      height="1em"
...
export function RadixItalic(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="1em"
      height="1em"
...
export function RadixUnderline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="1em"
      height="1em"
...
export function RadixStrikethrough(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="1em"
      height="1em"
...
export function RadixLink(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="1em"
      height="1em"
...
export function RadixCode(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="1em"
      height="1em"
...
export function BiListOl(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 16 16" {...props}>
      <g fill="currentColor">
        ...
        ></path>
        <path d="M1.713 11.865v-.474H2c.217 0 .363-.137.363-.317c0-.185-.158-.31-.361-.31c-.223 0-.367.152-.373.31h-.59c.016-.467.373-.787.986-.787c.588-.002.954.291.957.703a.595.595 0 0 1-.492.594v.033a.615.615 0 0 1 .569.631c.003.533-.502.8-1.051.8c-.656 0-1-.37-1.008-.794h.582c.008.178.186.306.422.309c.254 0 .424-.145.422-.35c-.002-.195-.155-.348-.414-.348h-.3zm-.004-4.699h-.604v-.035c0-.408.295-.844.958-.844c.583 0 .96.326.96.756c0 .389-.257.617-.476.848l-.537.572v.03h1.054V9H1.143v-.395l.957-.99c.138-.142.293-.304.293-.508c0-.18-.147-.32-.342-.32a.33.33 0 0 0-.342.338v.041zM2.564 5h-.635V2.924h-.031l-.598.42v-.567l.629-.443h.635V5z"></path>
      </g>
    </svg>
  )
}

export function BiListTask(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 16 16" {...props}>
      <g fill="currentColor">
        <path
...
export function BiListUl(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 16 16" {...props}>
      <path
        fill="currentColor"
...
export function MaterialSymbolsDone(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function MaterialSymbolsDeleteOutlineSharp(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function FluentDocumentPageTopLeft24Regular(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function IcBaselineTag(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function PhUserLight(props: SVGProps<SVGSVGElement>) {
  return (
