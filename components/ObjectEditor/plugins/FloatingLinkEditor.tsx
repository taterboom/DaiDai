...
import { MaterialSymbolsDone, MaterialSymbolsEdit } from "../../Common/icons"
...
export function FloatingLinkEditor() {
  ...
  return (
    <div
      ref={editorRef}
      className="fixed max-w-xs w-full p-2 opacity-0 bg-neutral-800/30 shadow-md transition-opacity backdrop-blur"
