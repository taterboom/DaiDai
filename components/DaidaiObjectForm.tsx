...
const DaidaiObjectArea = (props: ObjectEditorProps) => {
  return (
    <div className="w-[320px] sm:w-[500px] md:w-[640px] lg:w-[768px] xl:w-[1024px]">
...
export const DaidaiObjectEditor = ({
  ...
  return (
    <Popup show={popupShow} onClose={onClose}>
      <DaidaiObjectArea
        editable
        initialValue={daidaiObject}
        onSubmit={(result) => {
          update(id!, new DaidaiObject(result))
          onClose()
        }}
      ></DaidaiObjectArea>
    </Popup>
